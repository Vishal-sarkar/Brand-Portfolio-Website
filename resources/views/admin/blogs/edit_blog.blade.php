                        ...
                        <form action="{{route('update.blog',$blog->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="blog_title" class="form-control" type="text"
                                        id="example-text-input" value="{{$blog->blog_title}}">
                                    @error('blog_title')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="blog_tags" value="home, tech" class="form-control" type="text"
                                        id="example-text-input" data-role="tagsinput" value="{{$blog->blog_tags}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Blog
                                    Description</label>
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="blog_description">{!! $blog->blog_tags !!}
                                    </textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img class="rounded avatar-lg" id="showImage" src="{{(!empty($blog->blog_image))?url($blog->blog_image):url('upload/no_image.jpg')}}" alt="Card image cap">
                                </div>
                            </div>
